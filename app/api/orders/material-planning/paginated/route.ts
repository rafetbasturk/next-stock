...
import { getPaginatedMaterialPlanning } from "@/lib/server/orders";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const paginated = await getPaginatedMaterialPlanning({
    ...
    logError("GET /api/orders/material-planning/paginated failed", error, {
      requestId,
    });
